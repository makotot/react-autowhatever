...
Autowhatever.propTypes = {
  ...
  renderInputComponent: _propTypes2.default.func, // Renders the input component.
  ...
  shouldRenderSection: _propTypes2.default.func, // This function gets a section and returns whether it should be rendered, or not.
  ...
  inputComponent: _propTypes2.default.func, // When specified, it is used to render the input element
  ...
  focusedSectionIndex: _propTypes2.default.number, // Section index of the focused item
  focusedItemIndex: _propTypes2.default.number, // Focused item index (within a section)
